...
class DirectFaceRenderer extends MainRenderer {
	...
	init() {
		...
		this.setupAttributePointer(this.positionAttributeLocation, this.positionBuffer, 'POS');
		this.setupAttributePointer(this.normalAttributeLocation, this.normalBuffer, 'NORMAL');
		this.setupAttributePointer(this.colorAttributeLocation, this.colorBuffer, 'COLOR');
	}
